  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <Link
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${
                  isScrolled
                    ...
                    : "text-secondary-900 hover:bg-white/20"
                }`}
              >
                {link.name}
              </Link>
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="md:hidden py-4 bg-white rounded-lg shadow-large mt-2 border border-secondary-200">
            <div className="flex flex-col space-y-2 px-4">
              {navLinks.map((link) => (
                <Link
                  ...
                  className="px-4 py-3 rounded-lg text-secondary-700 hover:bg-secondary-100 transition-colors font-medium"
                >
                  {link.name}
                </Link>
              ))}
              ...
              <SignedOut>
                <div className="pt-4 border-t border-secondary-200 space-y-2">
                  <Link
                    href="/sign-in"
                    onClick={() => setIsMobileMenuOpen(false)}
                    className="block px-4 py-3 rounded-lg text-secondary-700 hover:bg-secondary-100 transition-colors font-medium text-center"
                  >
                    Login
                  </Link>
                  <Link
              ...
              <SignedIn>
                <div className="pt-4 border-t border-secondary-200 space-y-2">
                  ...
                  <Link
                    href="/manage-properties"
                    onClick={() => setIsMobileMenuOpen(false)}
                    className="flex items-center justify-center space-x-2 px-4 py-3 text-secondary-700 hover:bg-secondary-100 rounded-lg font-medium"
                  >
